        ...
        <div className="mt-6 space-y-6">
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-muted-foreground">
              Ласкаво просимо до спільноти музичних мрійників!
            </p>
          </div>

          {/* Привітання */}
          <div className="bg-festival-blue text-white p-6 rounded-lg">
            <h3 className="text-2xl font-bold mb-4 text-center">Вітаємо майбутнього громадянина!</h3>
            <p className="leading-relaxed text-center">
              Купивши квиток на фестиваль "Республіка Вейву", ви автоматично отримуєте 
              статус громадянина нашої культурної держави. Це не просто символічний титул - 
              це ваш пропуск до унікального світу музики, мистецтва та незабутніх вражень.
            </p>
          </div>
