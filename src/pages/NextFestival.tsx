              ...
              <div className="grid md:grid-cols-1 gap-6">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-4">
                    ...
                    <br />
                    ДУЖЕ рекомендується взяти з собою свій особистий посуд!
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-muted-foreground mb-4">
                    ...
                    <br />
                    4. Повернення витрат на паливо для машин для добирання до місця проведення фестивалю.
                    <br />
                    5. Оплату за отримання паспорту (якщо ви отримуєте його цього року).
                  </p>
                </div>
              </div>
            </CardContent>
